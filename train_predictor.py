...
def T5Trainer(dataframe, source_text, target_text, model_params, output_dir="../outputs/wikiHow_predictor"):
...
if __name__ == "__main__":
    ...
    path = "../data/wikiHow/wikiHowSegments.csv"
    df = pd.read_csv(path)
    df["method"] = "summarize: " + df["method"]
    ...
    T5Trainer(
        ...
        output_dir="../outputs/wikiHow_predictor",
    )